...
function routeBuilder(router) {
  return function (template) {
    router[template.req.method](template.req.path, function (req, res, next) {
      ...
      var matchers = [(0, _propMatchers.leftPropMatcher)(reqTemplate.headers, req.headers), (0, _propMatchers.allPropMatcher)(reqTemplate.query, req.query), (0, _propMatchers.allPropMatcher)(reqTemplate.body, req.body)];
